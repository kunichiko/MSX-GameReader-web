...
const T = {
  ja: {
    ...
    'macos.notice': '<b>macOS 26 (Tahoe) 以降:</b> USB スタックの仕様変更により本機が認識されない／制御転送が timeout する症状が確認されています。実機 Windows でのご利用を推奨します。',
  ...
  en: {
    ...
    'btn.showHex': 'Show hex preview',
    'btn.hideHex': 'Hide hex preview',
    'section.autoDump': 'Auto-dump cartridge',
    ...
    'macos.notice': '<b>macOS 26 (Tahoe) and later:</b> Due to USB stack changes, this device is known to fail to enumerate or to time out on control transfers. Use a real Windows PC instead.',
